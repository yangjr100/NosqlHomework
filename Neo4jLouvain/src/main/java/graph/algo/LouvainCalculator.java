...
public class LouvainCalculator {
    ...
    private double totalW;//缓存总权重
    private int[] nodeCommunityNo;//节点社区编号
    private double[] nodeBothWeight;//缓存节点度中心性（带权重版，无向）
    private double stickingK = 1.0;//黏合系数 多层情况下，越小越容易黏合
